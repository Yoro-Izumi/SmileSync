...
$python_script = 'inventory_forecast.py'; // Replace with your Python script
exec("$python_path $python_script $csv_file stock_forecast.csv"); // Replace with your Python path
