...
// SQL query to get the past appointment data, filtering for appointments that are less than the current date
$getAppointmentDetails = "
    ...
    WHERE 
        ...
        AND a.appointment_date_time <= CURDATE()  -- Filters for past appointments only
";
