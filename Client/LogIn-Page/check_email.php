...
$sql = "SELECT patient_account_id, patient_account_email FROM smilesync_patient_accounts";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $decrypted_email = decryptData($row['patient_account_email'],$key); // Decrypt stored email
