...
document.getElementById('submitExistingBtn').addEventListener('click', () => {
    createAlert('Success! Appointment has been successfully added.', 'alert-success');
});
...
//    createAlert('Appointment has been successfully edited! Changes have been saved.', 'alert-info');
//});
