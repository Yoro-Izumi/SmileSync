...
$appointmentReason = isset($_POST['services']) ? sanitize_input($_POST['services'], $appointmentsConn) : "";
    ...
    mysqli_stmt_bind_param($stmt, 'issss', $patientInfoID,$adminID,$email, $hashedPassword, $status);
    ...
    mysqli_stmt_bind_param($stmt, 'isisssi', $patientInfoID, $adminID,$covidFormID, $status, $appointmentDateTime, $appointmentReason, $emergencyContactID);
