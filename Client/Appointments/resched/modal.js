...
const fetchAppointmentDetails = (url, itemId, onSuccess) => {
    $.ajax({
        ...
        error: (xhr, status, error) => {
            ...
            // Fetch and display appointment details
            fetchAppointmentDetails("resched/appointment_crud/appointment_get.php", { id: itemId }, populateAppointmentModal);
        }
...
const setupDynamicActionsApprove = () => {
    document.body.addEventListener("click", (event) => {
        ...
        if (event.target.closest(".appointmentApprove")) {
            ...
            fetchAppointmentDetails("resched/appointment_crud/appointment_get.php", itemId, populateAppointmentModal);
        }
    });
};
...
const fetchAppointmentDetailsResched = (url, itemId, onSuccess) => {
    $.ajax({
        ...
        error: (xhr, status, error) => {
            ...
            // Fetch and display appointment details
            fetchAppointmentDetailsResched("resched/appointment_crud/appointment_get.php", { id: itemId }, populateAppointmentModalResched);
    ...
    if (doneForm && doneButton) {
        doneButton.addEventListener('click', function (e) {
            ...
            if (doneForm.checkValidity()) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'resched/appointment_crud/done_appointment.php',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
    ...
    if (doneForm && doneButton) {
        doneButton.addEventListener('click', function (e) {
            ...
            if (doneForm.checkValidity()) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'resched/appointment_crud/approve_appointment.php',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
...
//disableCheckbox
    ...
    function loadDropdownProducts() {
        $.ajax({
            url: 'resched/appointment_crud/get_products2.php',
            type: 'GET',
            success: function (response) {
...
function loadDropdownProcedures() {
    $.ajax({
        url: 'resched/appointment_crud/get_procedures.php',
        type: 'GET',
        success: function (response) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadDropdownProcedures() {
        $.ajax({
            url: 'resched/appointment_crud/get_procedures_approval.php',
            type: 'GET',
            success: function (response) {
...
$(document).ready(function () {
    ...
    $("#cancelForm").on("submit", function (e) {
      ...
      // AJAX request
      $.ajax({
        url: "resched/appointment_crud/cancel_appointment.php",
        type: "POST",
        data: formData,
...
$(document).ready(function () {
    ...
    $("#resched-submitButton").on("click", function (e) {
        ...
        // AJAX request
        $.ajax({
            url: "resched/appointment_crud/resched_appointment.php",
            type: "POST",
            data: formData,
            dataType: "json", // Expect JSON response
            success: function (response) {
