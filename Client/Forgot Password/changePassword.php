...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT `patient_account_email` FROM `smilesync_patient_accounts`";
    ...
    $sql = "UPDATE `smilesync_patient_accounts` SET `patient_account_password` = ? WHERE `patient_account_email` = ?";
